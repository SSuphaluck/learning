...
function MainContainer(props) {
  // Don't modify props [props.gender = 'Male']
  // pure function is mean never modify owns props
  const birthDate = '1995-01-06';
  ...
  return (
    <div>
      {/* uniderectional data flow: data sent from Parent to Child only */}
      <Welcome
        name="Bob"
        age="55"
        birthDate={birthDate}
